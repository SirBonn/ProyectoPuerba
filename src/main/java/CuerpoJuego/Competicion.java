                ...
                switch (sc.nextLine()) {
                    case "1":
                        ...
                        if (jugador.garajeAutos[slot].revisarGasolina(tamañoPista)) {
                            ...
                            System.out.println("\t\tUSTED NO CUENTA CON EL TANQUE LLENO\n\tSu gasolina actual es de: " + jugador.garajeAutos[slot].getGasolina() + " galones.");
                            System.out.println("\n\tDesea llenar el tanque para volver a competir?\n\t1.Si\t\t0.Regresar");
                            respuesta = sc.nextLine();
                            if ("1".equals(respuesta)) {
                                int resto = (100 - (jugador.garajeAutos[slot].getGasolina()));
                                if (jugador.revisiarPago(0, (resto * 2.5))) {
                                    jugador.garajeAutos[slot].llenarTanque(100);
                                    jugador.pagar(0, (resto) * 2.5);
